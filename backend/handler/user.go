...
func (h *userHandler) ShowAllUserHandler(c *gin.Context) {
	users, err := h.userService.SShowAllUser()
...
func (h *userHandler) RegisterHandler(c *gin.Context) {
	...
	newUser, err := h.userService.SRegisterUser(inputUser)
	if err != nil {
		responseError := helper.APIResponse("internal server error", 500, "error", gin.H{"errors": err.Error()})
...
func (h *userHandler) GetUserByIDHandler(c *gin.Context) {
	...
	user, err := h.userService.SFindUserByID(id)
	if err != nil {
...
func (h *userHandler) DeleteUserByIDHandler(c *gin.Context) {
	...
	user, err := h.userService.SDeleteUserByID(id)
...
func (h *userHandler) UpdateUserByIDHandler(c *gin.Context) {
	...
	user, err := h.userService.SUpdateUserByID(id, updateUserInput)
	if err != nil {
